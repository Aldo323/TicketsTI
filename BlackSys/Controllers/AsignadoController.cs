...
{
    [Authorize]
    public class AsignadoController : ApiController
    {
        ...
        public IHttpActionResult Get()
        {
            ...
            IEnumerable<Solicitudes> Informe = db.Database.SqlQuery<Solicitudes>("Sp_loadStringMenu  @User ='" + usuario + "', @idMenu= 21 ").ToList();
