...
{
    [Authorize]
    public class VencidosController : ApiController
    {
        ...
        public IHttpActionResult Get()
        {
            using (BlackSysEntities dc = new BlackSysEntities())
            {
                ...
                IEnumerable<Solicitudes> Informe = db.Database.SqlQuery<Solicitudes>("Sp_loadStringMenu  @User ='" + usuario + "', @idMenu= 13 ").ToList();
